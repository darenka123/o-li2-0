...
gdjs.MenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9449916);
}
}}
}
...
gdjs.MenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9452820);
}
}}
if (gdjs.MenuCode.condition1IsTrue_0.val) {
